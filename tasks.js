 ...
 * vis-1 widget set (`widgets/canvas-gauges.html` and `widgets/canvas-gauges/**`), which is maintained by hand and
...
const TARGET = 'widgets/vis-2-widgets-canvas-gauges';
...
function syncLegacyVersion() {
    ...
    const file = 'widgets/canvas-gauges.html';
